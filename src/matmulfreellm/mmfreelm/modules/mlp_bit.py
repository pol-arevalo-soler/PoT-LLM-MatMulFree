...
from mmfreelm.modules.activations import swiglu, swiglu_linear
...
class GatedMLPBit(nn.Module):
    ...
    def __init__(
        ...
        self.gate_proj = FusedBitLinear(self.hidden_size, self.intermediate_size, bias=False)
        self.up_proj = FusedBitLinear(self.hidden_size, self.intermediate_size, bias=False)
