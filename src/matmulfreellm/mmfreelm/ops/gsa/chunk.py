...
from mmfreelm.ops.common.chunk_h import chunk_bwd_dh, chunk_fwd_h
from mmfreelm.ops.gla.chunk import chunk_gla_bwd, chunk_gla_fwd
from mmfreelm.ops.utils import chunk_local_cumsum, softmax_bwd, softmax_fwd
from mmfreelm.ops.utils.op import exp, safe_exp
from mmfreelm.utils import input_guard
...
def chunk_gsa(
    ...
    Examples::
        ...
        >>> from mmfreelm.ops.gsa import fused_recurrent_gsa
