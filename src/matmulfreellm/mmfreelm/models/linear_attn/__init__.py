...
from mmfreelm.models.linear_attn.configuration_linear_attn import LinearAttentionConfig
from mmfreelm.models.linear_attn.modeling_linear_attn import LinearAttentionForCausalLM, LinearAttentionModel
